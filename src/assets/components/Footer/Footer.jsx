        ...
        <>
            <footer>
                ...
                <div className="min-h-80 bg-theme1-main relative">
                    <div className="flex flex-row flex-wrap mx-auto items-center gap-8 py-8 max-w-4xl">
                        <div className="flex-auto w-32 p-4">
                            <img src="src\assets\images\download.jpg" alt="download.jpg" />
                        </div>
                        <div className="flex flex-col flex-auto w-96 text-white gap-4">
                            ...
                            <button className="bg-white text-theme1-green font-bold border-none rounded px-4 py-1">Télécharger Maintenant</button>
                        </div>
                    </div>
                </div>
